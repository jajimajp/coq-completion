...
Complete induction_hypothesis plus_sum cubes_s cubes_zero sum_s sum_zero times_s plus_s distr_001 distr times_one times_zero plus_zero times_assoc times_comm plus_assoc plus_comm : a cubes one s sum times zero : hint
  for ((times (sum (s a)) (sum (s a))) = (cubes (s a))).
