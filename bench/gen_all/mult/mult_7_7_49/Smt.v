...
(* Zoal *)
Theorem check : (mult (s (s (s (s (s (s (s z))))))) (s (s (s (s (s (s (s z)))))))) =? (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s z))))))))))))))))))))))))))))))))))))))))))))))))).
Proof.
  smt.
Qed.
