...
Complete ax_c08 ax_c07 ax_c06 ax_c05 ax_c04 ax_c03 ax_c02 ax_c01 : a ld mult op_c rd unit : hint
  for ((mult (mult op_c op_c) a) = (mult a (mult op_c op_c))).

(* Goal *)
Theorem check : (mult (mult op_c op_c) a) = (mult a (mult op_c op_c)).
Proof.
