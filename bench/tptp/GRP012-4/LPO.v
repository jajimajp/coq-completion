...
Complete ax_right_inverse ax_right_identity ax_associativity ax_left_inverse ax_left_identity : a b identity inverse multiply : hint
  for ((inverse (multiply a b)) = (multiply (inverse b) (inverse a))).
