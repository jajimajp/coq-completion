...
Axiom single_axiom : forall X Y Z : Z, (double_divide (double_divide X (double_divide (double_divide (double_divide X Y) Z) (double_divide Y identity))) (double_divide identity identity)) = Z.
