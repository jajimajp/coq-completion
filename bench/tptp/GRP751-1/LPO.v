...
Parameter rd : G -> G -> G.
Hint Resolve a.
Axiom ax_f07 : forall A B C : G, (mult (mult A B) (mult C C)) = (mult (mult A C) (mult B C)).
...
Complete ax_f07 ax_f06 ax_f05 ax_f04 ax_f03 ax_f02 ax_f01 : a b c ld mult rd : hint
  for ((mult a (mult b c)) = (mult (mult (rd a a) b) (mult a c))).
