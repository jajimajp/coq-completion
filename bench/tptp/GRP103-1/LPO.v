...
Axiom ax_single_axiom : forall X Y Z : G, (double_divide (double_divide X (double_divide (double_divide identity Y) (double_divide Z (double_divide Y X)))) (double_divide identity identity)) = Z.
