...
Axiom single_axiom : forall X Y Z : G, (double_divide (double_divide identity X) (double_divide identity (double_divide (double_divide (double_divide X Y) identity) (double_divide Z Y)))) = Z.
