...
Variable rd : Z -> Z -> Z.
Variable unit : Z.
Axiom ax_c11 : forall A B : Z, (mult A B) = (mult B A).
Axiom ax_c10 : forall A B C : Z, (mult (mult A B) (mult C A)) = (mult A (mult (mult B C) A)).
Axiom ax_c09 : forall A B C : Z, (mult (mult A B) (mult C A)) = (mult (mult A (mult B C)) A).
Axiom ax_c08 : forall A B C : Z, (mult A (mult B (mult C B))) = (mult (mult (mult A B) C) B).
Axiom ax_c07 : forall A B C : Z, (mult A (mult B (mult A C))) = (mult (mult (mult A B) A) C).
