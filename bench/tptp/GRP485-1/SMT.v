...
Axiom ax_single_axiom : forall A B C : Z, (double_divide (double_divide A (double_divide (double_divide (double_divide A B) C) (double_divide B identity))) (double_divide identity identity)) = C.
