...
Axiom ax_lat4_7 : forall X Y Z : G, (greatest_lower_bound X (least_upper_bound Y Z)) = (least_upper_bound (greatest_lower_bound X Y) (greatest_lower_bound X Z)).
Axiom ax_lat4_6 : forall X Y Z : G, (least_upper_bound X (greatest_lower_bound Y Z)) = (greatest_lower_bound (least_upper_bound X Y) (least_upper_bound X Z)).
Axiom ax_lat4_5 : forall X : G, (negative_part X) = (greatest_lower_bound X identity).
Axiom ax_lat4_4 : forall X : G, (positive_part X) = (least_upper_bound X identity).
Axiom ax_lat4_3 : forall X Y : G, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_lat4_2 : forall X : G, (inverse (inverse X)) = X.
Axiom ax_lat4_1 : (inverse identity) = identity.
...
Complete ax_lat4_7 ax_lat4_6 ax_lat4_5 ax_lat4_4 ax_lat4_3 ax_lat4_2 ax_lat4_1 ax_monotony_glb2 ax_monotony_lub2 ax_monotony_glb1 ax_monotony_lub1 ax_glb_absorbtion ax_lub_absorbtion ax_idempotence_of_gld ax_idempotence_of_lub ax_associativity_of_lub ax_associativity_of_glb ax_symmetry_of_lub ax_symmetry_of_glb ax_associativity ax_left_inverse ax_left_identity : a greatest_lower_bound identity inverse least_upper_bound multiply negative_part positive_part : hint
  for (a = (multiply (positive_part a) (negative_part a))).
