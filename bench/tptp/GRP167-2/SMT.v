...
Axiom ax_lat4_7 : forall X Y Z : Z, (greatest_lower_bound X (least_upper_bound Y Z)) = (least_upper_bound (greatest_lower_bound X Y) (greatest_lower_bound X Z)).
Axiom ax_lat4_6 : forall X Y Z : Z, (least_upper_bound X (greatest_lower_bound Y Z)) = (greatest_lower_bound (least_upper_bound X Y) (least_upper_bound X Z)).
Axiom ax_lat4_5 : forall X : Z, (negative_part X) = (greatest_lower_bound X identity).
Axiom ax_lat4_4 : forall X : Z, (positive_part X) = (least_upper_bound X identity).
Axiom ax_lat4_3 : forall X Y : Z, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_lat4_2 : forall X : Z, (inverse (inverse X)) = X.
