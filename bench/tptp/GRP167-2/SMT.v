...
(* axioms *)
Axiom lat4_7 : forall X Y Z : Z, (greatest_lower_bound X (least_upper_bound Y Z)) = (least_upper_bound (greatest_lower_bound X Y) (greatest_lower_bound X Z)).
Axiom lat4_6 : forall X Y Z : Z, (least_upper_bound X (greatest_lower_bound Y Z)) = (greatest_lower_bound (least_upper_bound X Y) (least_upper_bound X Z)).
Axiom lat4_5 : forall X : Z, (negative_part X) = (greatest_lower_bound X identity).
Axiom lat4_4 : forall X : Z, (positive_part X) = (least_upper_bound X identity).
Axiom lat4_3 : forall X Y : Z, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom lat4_2 : forall X : Z, (inverse (inverse X)) = X.
Axiom lat4_1 : (inverse identity) = identity.
...
Add_lemmas lat4_7 lat4_6 lat4_5 lat4_4 lat4_3 lat4_2 lat4_1 monotony_glb2 monotony_lub2 monotony_glb1 monotony_lub1 glb_absorbtion lub_absorbtion idempotence_of_gld idempotence_of_lub associativity_of_lub associativity_of_glb symmetry_of_lub symmetry_of_glb associativity left_inverse left_identity.
