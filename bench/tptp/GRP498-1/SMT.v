...
Axiom ax_single_axiom : forall A B C : Z, (double_divide (double_divide identity (double_divide A (double_divide B identity))) (double_divide (double_divide B (double_divide C A)) identity)) = C.
