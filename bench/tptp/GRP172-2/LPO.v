...
(* axioms *)
Parameter G : Set.
Axiom p04d_2 : (greatest_lower_bound identity b) = identity.
Axiom p04d_1 : (greatest_lower_bound identity a) = identity.
...
Complete p04d_2 p04d_1 monotony_glb2 monotony_lub2 monotony_glb1 monotony_lub1 glb_absorbtion lub_absorbtion idempotence_of_gld idempotence_of_lub associativity_of_lub associativity_of_glb symmetry_of_lub symmetry_of_glb associativity left_inverse left_identity :  : hint
  for ((least_upper_bound identity (multiply a b)) = (multiply a b)).
