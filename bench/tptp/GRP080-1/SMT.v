...
Axiom single_axiom : forall X Y Z : Z, (double_divide (double_divide identity (double_divide X (double_divide Y identity))) (double_divide (double_divide Y (double_divide Z X)) identity)) = Z.
