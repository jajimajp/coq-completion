...
Axiom ax_single_axiom : forall X Y Z : G, (double_divide (double_divide identity X) (double_divide (double_divide (double_divide Y Z) (double_divide identity identity)) (double_divide X Z))) = Y.
