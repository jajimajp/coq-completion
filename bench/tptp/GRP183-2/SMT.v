...
Axiom ax_p20_3 : forall X Y : Z, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p20_2 : forall X : Z, (inverse (inverse X)) = X.
