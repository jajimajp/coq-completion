...
(* axioms *)
Parameter G : Set.
Axiom ax_lub1d_2 : (greatest_lower_bound b c) = b.
Axiom ax_lub1d_1 : (greatest_lower_bound a c) = a.
...
Complete ax_lub1d_2 ax_lub1d_1 monotony_glb2 monotony_lub2 monotony_glb1 monotony_lub1 glb_absorbtion lub_absorbtion idempotence_of_gld idempotence_of_lub associativity_of_lub associativity_of_glb symmetry_of_lub symmetry_of_glb associativity left_inverse left_identity :  : hint
  for ((least_upper_bound (least_upper_bound a b) c) = c).

(* Goal *)
Theorem check : (least_upper_bound (least_upper_bound a b) c) = c.
Proof.
