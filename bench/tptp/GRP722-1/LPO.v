...
Parameter unit : G.
Hint Resolve a.
Axiom ax_c08 : forall A B : G, (mult (mult A A) (mult B B)) = (mult (f A B) (f A B)).
...
Complete ax_c08 ax_c07 ax_c06 ax_c05 ax_c04 ax_c03 ax_c02 ax_c01 : a b f ld mult unit : hint
  for ((f a b) = (f b a)).
