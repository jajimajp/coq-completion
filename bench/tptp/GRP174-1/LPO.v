...
(* axioms *)
Parameter G : Set.
Axiom p05b_2 : (greatest_lower_bound identity (inverse a)) = (inverse a).
Axiom p05b_1 : (greatest_lower_bound identity a) = a.
...
Complete p05b_2 p05b_1 monotony_glb2 monotony_lub2 monotony_glb1 monotony_lub1 glb_absorbtion lub_absorbtion idempotence_of_gld idempotence_of_lub associativity_of_lub associativity_of_glb symmetry_of_lub symmetry_of_glb associativity left_inverse left_identity :  : hint
  for (identity = a).
