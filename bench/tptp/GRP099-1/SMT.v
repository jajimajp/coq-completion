...
Axiom single_axiom : forall X Y Z : Z, (double_divide (double_divide X (double_divide (double_divide Y (double_divide X Z)) (double_divide identity Z))) (double_divide identity identity)) = Y.
