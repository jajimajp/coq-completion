...
Parameter unit : G.
Hint Resolve a.
Axiom ax_c09 : forall A B : G, (mult (mult op_c op_c) (mult A B)) = (mult (mult (mult op_c op_c) A) B).
...
Complete ax_c09 ax_c08 ax_c07 ax_c06 ax_c05 ax_c04 ax_c03 ax_c02 ax_c01 : a b ld mult op_c rd unit : hint
  for ((mult a (mult b op_c)) = (mult (mult a b) op_c)).
