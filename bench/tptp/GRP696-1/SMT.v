...
Variable rd : Z -> Z -> Z.
Variable unit : Z.
Axiom ax_c11 : forall A : Z, (mult A (i A)) = unit.
Axiom ax_c10 : forall A : Z, (mult (i A) A) = unit.
Axiom ax_c09 : forall A B C : Z, (mult (mult A B) C) = (mult (mult A C) (ld C (mult B C))).
Axiom ax_c08 : forall A B C : Z, (mult A (mult B C)) = (mult (rd (mult A B) A) (mult A C)).
Axiom ax_c07 : forall A B : Z, (mult A (i (mult B A))) = (i B).
