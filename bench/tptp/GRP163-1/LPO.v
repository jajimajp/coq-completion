...
(* axioms *)
Parameter G : Set.
Axiom ax_transb_2 : (greatest_lower_bound b c) = b.
Axiom ax_transb_1 : (greatest_lower_bound a b) = a.
...
Complete ax_transb_2 ax_transb_1 monotony_glb2 monotony_lub2 monotony_glb1 monotony_lub1 glb_absorbtion lub_absorbtion idempotence_of_gld idempotence_of_lub associativity_of_lub associativity_of_glb symmetry_of_lub symmetry_of_glb associativity left_inverse left_identity :  : hint
  for ((greatest_lower_bound a c) = a).

(* Goal *)
Theorem check : (greatest_lower_bound a c) = a.
Proof.
