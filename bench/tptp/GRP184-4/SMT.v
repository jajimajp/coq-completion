...
Axiom ax_p21x_5 : forall X Y : Z, (inverse (least_upper_bound X Y)) = (greatest_lower_bound (inverse X) (inverse Y)).
Axiom ax_p21x_4 : forall X Y : Z, (inverse (greatest_lower_bound X Y)) = (least_upper_bound (inverse X) (inverse Y)).
Axiom ax_p21x_3 : forall X Y : Z, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p21x_2 : forall X : Z, (inverse (inverse X)) = X.
