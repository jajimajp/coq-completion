...
Axiom ax_p08b_3 : (greatest_lower_bound identity c) = identity.
Axiom ax_p08b_2 : (greatest_lower_bound identity b) = identity.
Axiom ax_p08b_1 : (greatest_lower_bound identity a) = identity.
...
Complete ax_p08b_3 ax_p08b_2 ax_p08b_1 ax_monotony_glb2 ax_monotony_lub2 ax_monotony_glb1 ax_monotony_lub1 ax_glb_absorbtion ax_lub_absorbtion ax_idempotence_of_gld ax_idempotence_of_lub ax_associativity_of_lub ax_associativity_of_glb ax_symmetry_of_lub ax_symmetry_of_glb ax_associativity ax_left_inverse ax_left_identity : a b c greatest_lower_bound identity inverse least_upper_bound multiply : hint
  for ((greatest_lower_bound (greatest_lower_bound a (multiply b c)) (multiply (greatest_lower_bound a b) (greatest_lower_bound a c))) = (greatest_lower_bound a (multiply b c))).

(* Goal *)
Theorem check : (greatest_lower_bound (greatest_lower_bound a (multiply b c)) (multiply (greatest_lower_bound a b) (greatest_lower_bound a c))) = (greatest_lower_bound a (multiply b c)).
Proof.
