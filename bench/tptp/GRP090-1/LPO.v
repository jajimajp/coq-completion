...
Axiom ax_single_axiom : forall X Y Z : G, (divide (divide X (divide Y Z)) (divide X Y)) = Z.

Complete ax_inverse ax_multiply ax_single_axiom : a1 a2 a3 a4 b1 b2 b3 b4 c3 divide inverse multiply : hint
