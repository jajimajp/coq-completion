...
Hint Resolve a.
Axiom ax_p12x_4 : forall X Y : G, (inverse (least_upper_bound X Y)) = (greatest_lower_bound (inverse X) (inverse Y)).
Axiom ax_p12x_3 : forall X Y : G, (inverse (greatest_lower_bound X Y)) = (least_upper_bound (inverse X) (inverse Y)).
Axiom ax_p12x_2 : (least_upper_bound a c) = (least_upper_bound b c).
Axiom ax_p12x_1 : (greatest_lower_bound a c) = (greatest_lower_bound b c).
