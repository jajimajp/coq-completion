...
Hint Resolve a.
Axiom ax_p12x_7 : forall X Y : G, (inverse (least_upper_bound X Y)) = (greatest_lower_bound (inverse X) (inverse Y)).
Axiom ax_p12x_6 : forall X Y : G, (inverse (greatest_lower_bound X Y)) = (least_upper_bound (inverse X) (inverse Y)).
Axiom ax_p12x_5 : (least_upper_bound a c) = (least_upper_bound b c).
Axiom ax_p12x_4 : (greatest_lower_bound a c) = (greatest_lower_bound b c).
Axiom ax_p12x_3 : forall X Y : G, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p12x_2 : forall X : G, (inverse (inverse X)) = X.
Axiom ax_p12x_1 : (inverse identity) = identity.
...
Complete ax_p12x_7 ax_p12x_6 ax_p12x_5 ax_p12x_4 ax_p12x_3 ax_p12x_2 ax_p12x_1 ax_monotony_glb2 ax_monotony_lub2 ax_monotony_glb1 ax_monotony_lub1 ax_glb_absorbtion ax_lub_absorbtion ax_idempotence_of_gld ax_idempotence_of_lub ax_associativity_of_lub ax_associativity_of_glb ax_symmetry_of_lub ax_symmetry_of_glb ax_associativity ax_left_inverse ax_left_identity : a b c greatest_lower_bound identity inverse least_upper_bound multiply : hint
  for (a = b).
