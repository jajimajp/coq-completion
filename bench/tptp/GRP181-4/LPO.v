...
(* axioms *)
Parameter G : Set.
Axiom p12x_7 : forall X Y : G, (inverse (least_upper_bound X Y)) = (greatest_lower_bound (inverse X) (inverse Y)).
Axiom p12x_6 : forall X Y : G, (inverse (greatest_lower_bound X Y)) = (least_upper_bound (inverse X) (inverse Y)).
Axiom p12x_5 : (least_upper_bound a c) = (least_upper_bound b c).
Axiom p12x_4 : (greatest_lower_bound a c) = (greatest_lower_bound b c).
Axiom p12x_3 : forall X Y : G, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom p12x_2 : forall X : G, (inverse (inverse X)) = X.
