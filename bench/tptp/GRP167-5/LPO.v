...
Axiom ax_lat4_1 : forall X : G, (positive_part X) = (least_upper_bound X identity).
Axiom ax_p10 : forall A B : G, (inverse (least_upper_bound A B)) = (greatest_lower_bound (inverse A) (inverse B)).
