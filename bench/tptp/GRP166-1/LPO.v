...
(* axioms *)
Parameter G : Set.
Axiom lat2a_2 : (least_upper_bound b identity) = b.
Axiom lat2a_1 : (least_upper_bound a identity) = a.
...
Complete lat2a_2 lat2a_1 monotony_glb2 monotony_lub2 monotony_glb1 monotony_lub1 glb_absorbtion lub_absorbtion idempotence_of_gld idempotence_of_lub associativity_of_lub associativity_of_glb symmetry_of_lub symmetry_of_glb associativity left_inverse left_identity :  : hint
  for ((least_upper_bound a (multiply a b)) = (multiply a b)).

(* Goal *)
Theorem check : (least_upper_bound a (multiply a b)) = (multiply a b).
Proof.
