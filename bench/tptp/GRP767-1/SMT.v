...
Axiom sos18 : forall A B C : Z, (l A A (product B C)) = (product (l A A B) (l A A C)).
Axiom sos17 : forall A B C : Z, (l A B C) = (difference (product A B) (product A (product B C))).
...
Add_lemmas sos20 sos19 sos18 sos17 sos16 sos15 sos14 sos13 sos12 sos11 sos10 sos09 sos08 sos07 sos06 sos05 sos04 sos03 sos02 sos01.
