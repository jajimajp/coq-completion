...
Axiom single_axiom : forall X Y Z : Z, (double_divide (double_divide X (double_divide (double_divide Y (double_divide Z X)) (double_divide Z identity))) (double_divide identity identity)) = Y.
