...
Axiom ax_p11_3 : forall X Y : Z, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p11_2 : forall X : Z, (inverse (inverse X)) = X.
