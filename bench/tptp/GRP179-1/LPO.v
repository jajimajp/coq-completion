...
Complete monotony_glb2 monotony_lub2 monotony_glb1 monotony_lub1 glb_absorbtion lub_absorbtion idempotence_of_gld idempotence_of_lub associativity_of_lub associativity_of_glb symmetry_of_lub symmetry_of_glb associativity left_inverse left_identity :  : hint
  for ((inverse (least_upper_bound a b)) = (greatest_lower_bound (inverse a) (inverse b))).

(* Goal *)
Theorem check : (inverse (least_upper_bound a b)) = (greatest_lower_bound (inverse a) (inverse b)).
Proof.
