...
Hint Resolve a.
Axiom ax_p18_3 : forall X Y : G, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p18_2 : forall X : G, (inverse (inverse X)) = X.
