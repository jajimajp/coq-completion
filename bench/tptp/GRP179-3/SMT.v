...
Axiom ax_p18_3 : forall X Y : Z, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p18_2 : forall X : Z, (inverse (inverse X)) = X.
Axiom ax_p18_1 : (inverse identity) = identity.
