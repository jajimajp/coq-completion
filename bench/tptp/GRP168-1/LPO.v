...
(* axioms *)
Parameter G : Set.
Axiom p01a_1 : (least_upper_bound a b) = b.
...
Complete p01a_1 monotony_glb2 monotony_lub2 monotony_glb1 monotony_lub1 glb_absorbtion lub_absorbtion idempotence_of_gld idempotence_of_lub associativity_of_lub associativity_of_glb symmetry_of_lub symmetry_of_glb associativity left_inverse left_identity :  : hint
  for ((least_upper_bound (multiply (inverse c) (multiply a c)) (multiply (inverse c) (multiply b c))) = (multiply (inverse c) (multiply b c))).

(* Goal *)
Theorem check : (least_upper_bound (multiply (inverse c) (multiply a c)) (multiply (inverse c) (multiply b c))) = (multiply (inverse c) (multiply b c)).
Proof.
