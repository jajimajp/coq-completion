...
Parameter unit : G.
Hint Resolve a.
Axiom ax_c11 : forall A : G, (mult A (i A)) = unit.
Axiom ax_c10 : forall A : G, (mult (i A) A) = unit.
Axiom ax_c09 : forall A B C : G, (mult (mult A B) C) = (mult (mult A C) (ld C (mult B C))).
Axiom ax_c08 : forall A B C : G, (mult A (mult B C)) = (mult (rd (mult A B) A) (mult A C)).
Axiom ax_c07 : forall A B : G, (mult A (i (mult B A))) = (i B).
...
Complete ax_c11 ax_c10 ax_c09 ax_c08 ax_c07 ax_c06 ax_c05 ax_c04 ax_c03 ax_c02 ax_c01 : a b c i ld mult rd unit : hint
  for ((mult (mult a b) (mult b (mult c b))) = (mult (mult a (mult b (mult b c))) b)).
