...
Complete ax_f07 ax_f06 ax_f05 ax_f04 ax_f03 ax_f02 ax_f01 : ld mult rd x0 x1 x2 : hint
  for ((ld (rd x0 x1) (mult (rd x0 x1) x2)) = (ld x0 (mult x0 x2))).

(* Goal *)
Theorem check : (ld (rd x0 x1) (mult (rd x0 x1) x2)) = (ld x0 (mult x0 x2)).
Proof.
