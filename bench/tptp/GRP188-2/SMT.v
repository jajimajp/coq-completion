...
Axiom ax_p38a_3 : forall X Y : Z, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p38a_2 : forall X : Z, (inverse (inverse X)) = X.
