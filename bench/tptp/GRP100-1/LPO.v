...
Axiom ax_single_axiom : forall X Y Z : G, (double_divide (double_divide X (double_divide (double_divide Y (double_divide X Z)) (double_divide Z identity))) (double_divide identity identity)) = Y.
