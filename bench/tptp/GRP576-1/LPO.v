...
Axiom ax_single_axiom : forall A B C : G, (double_divide (double_divide A (double_divide (double_divide B (double_divide C A)) (double_divide C identity))) (double_divide identity identity)) = B.

Complete ax_identity ax_inverse ax_multiply ax_single_axiom : a b double_divide identity inverse multiply : hint
