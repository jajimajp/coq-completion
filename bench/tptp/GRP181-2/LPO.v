...
Axiom ax_p12_5 : (least_upper_bound a c) = (least_upper_bound b c).
Axiom ax_p12_4 : (greatest_lower_bound a c) = (greatest_lower_bound b c).
Axiom ax_p12_3 : forall X Y : G, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p12_2 : forall X : G, (inverse (inverse X)) = X.
Axiom ax_p12_1 : (inverse identity) = identity.
