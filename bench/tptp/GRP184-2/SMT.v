...
Axiom ax_p21_3 : forall X Y : Z, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p21_2 : forall X : Z, (inverse (inverse X)) = X.
