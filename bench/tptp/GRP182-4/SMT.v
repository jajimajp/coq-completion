...
Axiom ax_p17b_3 : forall X Y : Z, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p17b_2 : forall X : Z, (inverse (inverse X)) = X.
Axiom ax_p17b_1 : (inverse identity) = identity.
...
Add_lemmas ax_p17b_3 ax_p17b_2 ax_p17b_1 ax_monotony_glb2 ax_monotony_lub2 ax_monotony_glb1 ax_monotony_lub1 ax_glb_absorbtion ax_lub_absorbtion ax_idempotence_of_gld ax_idempotence_of_lub ax_associativity_of_lub ax_associativity_of_glb ax_symmetry_of_lub ax_symmetry_of_glb ax_associativity ax_left_inverse ax_left_identity.

(* Goal *)
Theorem check : (greatest_lower_bound identity (least_upper_bound a identity)) = identity.
Proof.
  smt.
Qed.
