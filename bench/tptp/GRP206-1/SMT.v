...
(* axioms *)
Axiom moufang4 : forall X Y Z : Z, (multiply X (multiply (multiply Y Z) X)) = (multiply (multiply X Y) (multiply Z X)).
...
Add_lemmas moufang4 left_inverse right_inverse right_division_multiply multiply_right_division left_division_multiply multiply_left_division right_identity left_identity.
