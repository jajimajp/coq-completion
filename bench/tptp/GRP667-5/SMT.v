...
(* axioms *)
Axiom c09 : forall A : Z, (mult (f A) (f A)) = A.
Axiom c08 : forall A B : Z, (mult (mult A B) A) = (mult A (mult B A)).
Axiom c07 : forall A B C : Z, (mult (mult A B) (mult (mult C B) C)) = (mult (mult A (mult (mult B C) B)) C).
