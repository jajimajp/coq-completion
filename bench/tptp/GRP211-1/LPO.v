...
Complete ax_associativity ax_left_inverse ax_left_identity : identity inverse multiply sk_c1 sk_c2 sk_c3 sk_c4 sk_c5 sk_c6 sk_c7 sk_c8 : hint
  for ((multiply sk_c1 sk_c2) = sk_c8).

(* Goal *)
Theorem check : (multiply sk_c1 sk_c2) = sk_c8.
Proof.
