...
Hint Resolve a.
Axiom ax_p22b_3 : forall X Y : G, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p22b_2 : forall X : G, (inverse (inverse X)) = X.
Axiom ax_p22b_1 : (inverse identity) = identity.
