...
Axiom ax_single_axiom : forall A B C : Z, (double_divide (double_divide identity A) (double_divide (double_divide (double_divide B C) (double_divide identity identity)) (double_divide A C))) = B.
