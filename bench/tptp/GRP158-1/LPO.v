...
(* axioms *)
Parameter G : Set.
Axiom ax_mono2b_1 : (greatest_lower_bound a b) = a.
...
Complete ax_mono2b_1 monotony_glb2 monotony_lub2 monotony_glb1 monotony_lub1 glb_absorbtion lub_absorbtion idempotence_of_gld idempotence_of_lub associativity_of_lub associativity_of_glb symmetry_of_lub symmetry_of_glb associativity left_inverse left_identity :  : hint
  for ((greatest_lower_bound (multiply c a) (multiply c b)) = (multiply c a)).

(* Goal *)
Theorem check : (greatest_lower_bound (multiply c a) (multiply c b)) = (multiply c a).
Proof.
