...
Axiom ax_p23x_3 : forall X Y : Z, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p23x_2 : forall X : Z, (inverse (inverse X)) = X.
