...
Axiom ax_p23x_3 : forall X Y : G, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p23x_2 : forall X : G, (inverse (inverse X)) = X.
Axiom ax_p23x_1 : (inverse identity) = identity.
