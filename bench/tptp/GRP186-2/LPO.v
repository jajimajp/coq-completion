...
Axiom ax_p23_3 : forall X Y : G, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p23_2 : forall X : G, (inverse (inverse X)) = X.
