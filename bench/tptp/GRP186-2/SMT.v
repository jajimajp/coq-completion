...
Axiom ax_p23_3 : forall X Y : Z, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
Axiom ax_p23_2 : forall X : Z, (inverse (inverse X)) = X.
Axiom ax_p23_1 : (inverse identity) = identity.
