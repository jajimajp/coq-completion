...
Variable x1 : Z.
Variable x2 : Z.
Axiom ax_sos19 : forall A B C : Z, (t (eta A) (product B C)) = (product (t (eta A) B) (t (eta A) C)).
Axiom ax_sos18 : forall A B : Z, (t A B) = (quotient (product A B) A).
Axiom ax_sos17 : forall A B : Z, (product A (product B (eta A))) = (product (product A B) (eta A)).
Axiom ax_sos16 : forall A B : Z, (product A (product (eta A) B)) = (product (j (j A)) B).
Axiom ax_sos15 : forall A B : Z, (product (i (i A)) B) = (product (eta A) (product A B)).
Axiom ax_sos14 : forall A B C : Z, (l A A (product B C)) = (product (l A A B) (l A A C)).
Axiom ax_sos13 : forall A B C : Z, (l A B C) = (difference (product A B) (product A (product B C))).
...
Add_lemmas ax_sos19 ax_sos18 ax_sos17 ax_sos16 ax_sos15 ax_sos14 ax_sos13 ax_sos12 ax_sos11 ax_sos10 ax_sos09 ax_sos08 ax_sos07 ax_sos06 ax_sos05 ax_sos04 ax_sos03 ax_sos02 ax_sos01.
