...
(* axioms *)
Parameter G : Set.
Axiom c08 : forall A B : G, (f A B) = (ld (mult (ld (mult A B) A) (ld (mult A B) B)) unit).
...
Complete c08 c07 c06 c05 c04 c03 c02 c01 :  : hint
  for ((mult (mult a a) (mult b b)) = (mult (f a b) (f a b))).
