...
Complete ax_f13 ax_f12 ax_f11 ax_f10 ax_f09 ax_f08 ax_f07 ax_f06 ax_f05 ax_f04 ax_f03 ax_f02 ax_f01 : ld mult op_c op_d op_e op_f rd unit x4 x5 : hint
  for ((mult op_f (mult x4 x5)) = (mult (mult op_f x4) x5)).

(* Goal *)
Theorem check : (mult op_f (mult x4 x5)) = (mult (mult op_f x4) x5).
Proof.
