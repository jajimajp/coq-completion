...
(* axioms *)
Parameter G : Set.
Axiom p07_1 : forall X Y : G, (inverse (multiply X Y)) = (multiply (inverse Y) (inverse X)).
...
Complete p07_1 monotony_glb2 monotony_lub2 monotony_glb1 monotony_lub1 glb_absorbtion lub_absorbtion idempotence_of_gld idempotence_of_lub associativity_of_lub associativity_of_glb symmetry_of_lub symmetry_of_glb associativity left_inverse left_identity :  : hint
  for ((multiply c (multiply (least_upper_bound a b) d)) = (least_upper_bound (multiply c (multiply a d)) (multiply c (multiply b d)))).

(* Goal *)
Theorem check : (multiply c (multiply (least_upper_bound a b) d)) = (least_upper_bound (multiply c (multiply a d)) (multiply c (multiply b d))).
Proof.
