...
Axiom single_axiom : forall X Y Z : Z, (double_divide X (double_divide (double_divide (double_divide identity (double_divide (double_divide X identity) (double_divide Y Z))) Y) identity)) = Z.
