...
let%expect_test "parse" =
  ...
  [%expect {|
    ...
    Crit: 5: +(-(0()),X4) -> X4 with 4: +(-(X3),+(X3,X2)) -> X2 and 0: +(0(),X0) -> X0 with superposition +(-(0()),+(0(),X4))
    Crit: 6: +(-(-(X4)),0()) -> X4 with 4: +(-(X3),+(X3,X2)) -> X2 and 1: +(-(X1),X1) -> 0() with superposition +(-(-(X4)),+(-(X4),X4))
    Crit: 7: +(-(-(X4)),X5) -> +(X4,X5) with 4: +(-(X3),+(X3,X2)) -> X2 and 4: +(-(X3),+(X3,X2)) -> X2 with superposition +(-(-(X4)),+(-(X4),+(X4,X5)))
    Crit: 8: +(-(+(X4,X5)),+(X4,+(X5,X6))) -> X6 with 4: +(-(X3),+(X3,X2)) -> X2 and 2: +(+(X1,X0),X2) -> +(X1,+(X0,X2)) with superposition +(-(+(X4,X5)),+(+(X4,X5),X6))
    ...
    Crit: 12: -(-(X4)) -> +(X4,0()) with 7: +(-(-(X4)),X5) -> +(X4,X5) and 9: +(X4,0()) -> X4 with superposition +(-(-(X4)),0())
    Crit: 13: +(-(-(X4)),0()) -> X4 with 4: +(-(X3),+(X3,X2)) -> X2 and 1: +(-(X1),X1) -> 0() with superposition +(-(-(X4)),+(-(X4),X4))
    Crit: 14: +(X4,+(-(X4),X7)) -> X7 with 7: +(-(-(X4)),X5) -> +(X4,X5) and 4: +(-(X3),+(X3,X2)) -> X2 with superposition +(-(-(X4)),+(-(X4),X7))
    Crit: 15: +(-(+(X4,-(0()))),+(X4,X7)) -> X7 with 8: +(-(+(X4,X5)),+(X4,+(X5,X6))) -> X6 and 5: +(-(0()),X4) -> X4 with superposition +(-(+(X4,-(0()))),+(X4,+(-(0()),X7)))
    Crit: 16: +(-(+(X4,-(X7))),+(X4,0())) -> X7 with 8: +(-(+(X4,X5)),+(X4,+(X5,X6))) -> X6 and 1: +(-(X1),X1) -> 0() with superposition +(-(+(X4,-(X7))),+(X4,+(-(X7),X7)))
    Crit: 17: +(-(+(-(+(X5,X6)),X5)),0()) -> X6 with 8: +(-(+(X4,X5)),+(X4,+(X5,X6))) -> X6 and 1: +(-(X1),X1) -> 0() with superposition +(-(+(-(+(X5,X6)),X5)),+(-(+(X5,X6)),+(X5,X6)))
    Crit: 18: +(-(+(-(+(X7,X8)),X7)),X9) -> +(X8,X9) with 8: +(-(+(X4,X5)),+(X4,+(X5,X6))) -> X6 and 8: +(-(+(X4,X5)),+(X4,+(X5,X6))) -> X6 with superposition +(-(+(-(+(X7,X8)),X7)),+(-(+(X7,X8)),+(X7,+(X8,X9))))
    Crit: 19: +(-(+(X4,-(X7))),+(X4,X8)) -> +(X7,X8) with 8: +(-(+(X4,X5)),+(X4,+(X5,X6))) -> X6 and 4: +(-(X3),+(X3,X2)) -> X2 with superposition +(-(+(X4,-(X7))),+(X4,+(-(X7),+(X7,X8))))
    Crit: 20: +(-(+(X4,-(-(X7)))),+(X4,+(X7,X8))) -> X8 with 8: +(-(+(X4,X5)),+(X4,+(X5,X6))) -> X6 and 7: +(-(-(X4)),X5) -> +(X4,X5) with superposition +(-(+(X4,-(-(X7)))),+(X4,+(-(-(X7)),X8)))
    Crit: 21: +(-(+(X4,+(X7,X8))),+(X4,+(X7,+(X8,X9)))) -> X9 with 8: +(-(+(X4,X5)),+(X4,+(X5,X6))) -> X6 and 2: +(+(X1,X0),X2) -> +(X1,+(X0,X2)) with superposition +(-(+(X4,+(X7,X8))),+(X4,+(+(X7,X8),X9)))
    ...
    Crit: 26: -(+(X11,-(+(X10,X11)))) -> X10 with 22: -(+(-(+(X5,X6)),X5)) -> X6 and 18: +(-(+(-(+(X7,X8)),X7)),X9) -> +(X8,X9) with superposition -(+(-(+(-(+(X10,X11)),X10)),-(+(X10,X11))))
    Crit: 27: +(-(+(X4,X8)),X4) -> -(X8) with 23: +(-(+(X4,-(X7))),X4) -> X7 and 24: -(-(X4)) -> X4 with superposition +(-(+(X4,-(-(X8)))),X4)
    Crit: 28: +(X8,+(-(+(X7,X8)),X7)) -> 0() with 18: +(-(+(-(+(X7,X8)),X7)),X9) -> +(X8,X9) and 1: +(-(X1),X1) -> 0() with superposition +(-(+(-(+(X7,X8)),X7)),+(-(+(X7,X8)),X7))
    Crit: 29: -(+(-(X9),X8)) -> +(-(X8),X9) with 22: -(+(-(+(X5,X6)),X5)) -> X6 and 14: +(X4,+(-(X4),X7)) -> X7 with superposition -(+(-(+(X8,+(-(X8),X9))),X8))
    Crit: 30: -(+(-(X8),-(X7))) -> +(X7,X8) with 22: -(+(-(+(X5,X6)),X5)) -> X6 and 4: +(-(X3),+(X3,X2)) -> X2 with superposition -(+(-(+(-(X7),+(X7,X8))),-(X7)))
    Crit: 31: +(X5,+(X6,-(+(X5,X6)))) -> 0() with 11: +(X4,-(X4)) -> 0() and 2: +(+(X1,X0),X2) -> +(X1,+(X0,X2)) with superposition +(+(X5,X6),-(+(X5,X6)))
    Crit: 32: -(+(-(X9),-(+(X8,-(X9))))) -> X8 with 22: -(+(-(+(X5,X6)),X5)) -> X6 and 23: +(-(+(X4,-(X7))),X4) -> X7 with superposition -(+(-(+(-(+(X8,-(X9))),X8)),-(+(X8,-(X9)))))
    Crit: 33: +(-(X9),-(+(-(X7),-(X9)))) -> X7 with 23: +(-(+(X4,-(X7))),X4) -> X7 and 23: +(-(+(X4,-(X7))),X4) -> X7 with superposition +(-(+(-(+(-(X7),-(X9))),-(X7))),-(+(-(X7),-(X9))))
    Crit: 34: +(-(+(X4,X7)),+(X4,0())) -> -(X7) with 8: +(-(+(X4,X5)),+(X4,+(X5,X6))) -> X6 and 11: +(X4,-(X4)) -> 0() with superposition +(-(+(X4,X7)),+(X4,+(X7,-(X7))))
    Crit: 35: +(-(+(X9,-(X7))),0()) -> +(X7,-(X9)) with 19: +(-(+(X4,-(X7))),+(X4,X8)) -> +(X7,X8) and 11: +(X4,-(X4)) -> 0() with superposition +(-(+(X9,-(X7))),+(X9,-(X9)))
    Crit: 36: +(-(+(-(X9),-(X7))),0()) -> +(X7,X9) with 19: +(-(+(X4,-(X7))),+(X4,X8)) -> +(X7,X8) and 1: +(-(X1),X1) -> 0() with superposition +(-(+(-(X9),-(X7))),+(-(X9),X9))
    Simp: 37: -(+(X9,-(X7))) -> +(X7,-(X9)) with ,9
    Crit: 38: -(+(X9,X10)) -> +(-(X10),-(X9)) with 37: -(+(X9,-(X7))) -> +(X7,-(X9)) and 24: -(-(X4)) -> X4 with superposition -(+(X9,-(-(X10))))
    ...
    Crit: 43: +(-(+(X4,X8)),+(X4,X9)) -> +(-(X8),X9) with 8: +(-(+(X4,X5)),+(X4,+(X5,X6))) -> X6 and 14: +(X4,+(-(X4),X7)) -> X7 with superposition +(-(+(X4,X8)),+(X4,+(X8,+(-(X8),X9))))
    Crit: 44: -(+(X10,+(X11,-(X7)))) -> +(X7,-(+(X10,X11))) with 37: -(+(X9,-(X7))) -> +(X7,-(X9)) and 2: +(+(X1,X0),X2) -> +(X1,+(X0,X2)) with superposition -(+(+(X10,X11),-(X7)))
    Crit: 45: +(+(X7,X8),+(X9,-(+(X7,+(X8,X9))))) -> 0() with 31: +(X5,+(X6,-(+(X5,X6)))) -> 0() and 2: +(+(X1,X0),X2) -> +(X1,+(X0,X2)) with superposition +(+(X7,X8),+(X9,-(+(+(X7,X8),X9))))
    Crit: 46: +(X5,+(X7,+(X8,-(+(X5,+(X7,X8)))))) -> 0() with 31: +(X5,+(X6,-(+(X5,X6)))) -> 0() and 2: +(+(X1,X0),X2) -> +(X1,+(X0,X2)) with superposition +(X5,+(+(X7,X8),-(+(X5,+(X7,X8)))))
    Crit: 47: +(X7,+(X8,+(X6,-(+(+(X7,X8),X6))))) -> 0() with 31: +(X5,+(X6,-(+(X5,X6)))) -> 0() and 2: +(+(X1,X0),X2) -> +(X1,+(X0,X2)) with superposition +(+(X7,X8),+(X6,-(+(+(X7,X8),X6))))
    Crit: 48: -(+(X9,+(X10,X11))) -> +(-(X11),-(+(X9,X10))) with 27: +(-(+(X4,X8)),X4) -> -(X8) and 8: +(-(+(X4,X5)),+(X4,+(X5,X6))) -> X6 with superposition +(-(+(-(+(X9,X10)),+(X9,+(X10,X11)))),-(+(X9,X10)))
    Crit: 49: +(-(-(X10)),+(-(+(X9,X10)),+(X9,X6))) -> X6 with 8: +(-(+(X4,X5)),+(X4,+(X5,X6))) -> X6 and 27: +(-(+(X4,X8)),X4) -> -(X8) with superposition +(-(+(-(+(X9,X10)),X9)),+(-(+(X9,X10)),+(X9,X6)))
    Completed: 9: +(X4,0()) -> X4
    Completed: 0: +(0(),X0) -> X0
    Completed: 1: +(-(X1),X1) -> 0()
